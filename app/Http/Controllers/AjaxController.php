...
class AjaxController extends Controller
{
    ...
    public function getItemCatagory(Request $request)
    {
        // echo $request->item_catagory;
        // exit;
        $itemName= itemName::where('item_catagories_id',$request->item_catagory)->get();
        return json_encode($itemName);
    }
    public function getItemNameByCategory(Request $request)
    {
         $itemDetail= itemName::where('id',$request->item_name)->get();
    ...
    // }
    // public function getItemByCatagoryType(Request $request)
    // {
