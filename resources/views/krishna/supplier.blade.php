      ...
      <div  class="col-lg-12 text-center"style="display:none">
       ...
       <div class="modal fade" id="modal-animation-3">
                  <div class="modal-dialog">
                     {{ Form::open(['url' => 'krishna/supplier/add','files' => 'true' ,'enctype' => 'multipart/form-data', 'autocomplete' => 'OFF']) }} 
                    {{ csrf_field() }}
                  ...
                  <div class="row">
                    <div class="col-md-12">
                    <div class="form-groupp">
                    <label class="form-col-form-label" for="name">Address</label>
                    {{Form::text('address', isset($address)?$address: '', ['class' => 'form-control form-control ','id'=>'address','required', 'placeholder' => 'Address']  )}}
                    <div class="invalid-feedback">
                    {{ $errors->has('address') ? $errors->first('name', ':message') : '' }}
                    </div>
                    </div>
                    </div>
...
{{--           {{ Form::open(['url' => 'krishna/supplier/add','files' => 'true' ,'enctype' => 'multipart/form-data', 'autocomplete' => 'OFF']) }} 
 --}}
          {{ isset($id)?Form::open(['url' => 'krishna/supplier/update','files' => 'true' ,'enctype' => 'multipart/form-data', 'autocomplete' => 'OFF']) : Form::open(['url' => 'krishna/supplier/add','files' => 'true' ,'enctype' => 'multipart/form-data', 'autocomplete' => 'OFF']) }} 
  ...
  <div class="card">
    ...
    <div class="row">
        <div class="col-sm-12" class="text-center">
          {{ Form::open(['url' => 'krishna/supplier/search','files' => 'true' ,'enctype' => 'multipart/form-data', 'autocomplete' => 'OFF']) }} 
          <div class="row">
            <!-- <div class="col-sm-4">
            <div class="form-group">
            ...
            {{Form::text('supplier_name', isset($supplier_name)?$supplier_name: '', ['class' => 'form-control form-control-rounded','id'=>'supplier_name', 'placeholder' => ' Supplier Name']  )}}
            </div>
          ...
          <div class="row">
            ...
            <input type="email"  id="email" class="form-control form-control-rounded" name="email">
            </div>
            </div>
              ...
              <table id="example" class="table table-bordered" >
                ...
                @foreach($supplier as $key => $value)
                  <tr>
                    ...
                    <td >
                    <a href="{{ url('/')}}/krishna/supplier/add/{{ $value['id'] }}" class="btn btn-success btn-sm"><i class="fa fa-edit"></i></a> 
                    <a href="{{ url('/')}}/krishna/supplier/trash/{{ $value['id']}} " class="btn btn-danger btn-sm" onclick="return confirm('Are you sure you want to delete this user?');"><i class="fa fa-remove"></i></a>
                    </td>
                  </tr>  
                @endforeach
                </tbody>
